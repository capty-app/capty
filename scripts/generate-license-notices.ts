...
function renderExternalComponents(): string {
  return [
    ...
    '',
    'The shipped FFmpeg executable is built with --enable-gpl, --enable-version3, and x264 statically linked, so the combined binary is distributed under GPL-3.0. The LGPLv3 text is included for the LGPL-licensed FFmpeg components.',
    '',
