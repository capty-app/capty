...
function renderExternalComponents(): string {
  return [
    ...
    'License texts: ffmpeg/COPYING.GPLv3 and ffmpeg/COPYING.LGPLv3, alongside this file.',
    '',
    'The shipped FFmpeg executable is built with --enable-gpl, --enable-version3, and x264 statically linked, so the combined binary is distributed under GPL-3.0-or-later. The LGPLv3 text is included for the LGPL-licensed FFmpeg components.',
    '',
    'x264 (commit b35605ace3ddf7c1a5d67a2eb553f034aef41d55)',
    'License: GPL-2.0-or-later',
    'Source: https://code.videolan.org/videolan/x264/-/tree/b35605ace3ddf7c1a5d67a2eb553f034aef41d55',
    'License text: x264/COPYING, alongside this file.',
    '',
    'whisper.cpp v1.8.3',
    'License: MIT',
