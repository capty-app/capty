...
export default function TrackLabel({ icon: Icon, text }: TrackLabelProps) {
  return (
    ...
    >
      <div className="bg-card group-hover/label:bg-secondary group-hover/label:ring-border pointer-events-none flex h-full w-max max-w-8 items-center gap-1.5 overflow-hidden rounded-r-md px-2 transition-all group-hover/label:max-w-44 group-hover/label:shadow-sm group-hover/label:ring-1">
